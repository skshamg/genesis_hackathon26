...
from sybil_shield.core.detector import trust_scores, pick_seeds, extra_structural_features
...
def build_features_with_seeds(G, node_index, seeds):
    ...
    cols.extend(_rank(feature) for feature in extra_structural_features(G, nodes, seeds, seed=0))
